...
export class Modal extends React.Component {
    constructor(props) {
        ...
        this.renderMask = () => (React.createElement(SvgMask, { style: styles.overlayContainer, size: this.state.size, position: this.state.position, easing: this.props.easing, animationDuration: this.props.animationDuration, backdropColor: this.props.backdropColor, currentStep: this.props.currentStep, maskOffset: this.props.maskOffset, borderRadius: this.props.borderRadius, dismissOnPress: this.props.dismissOnPress, stop: this.props.stop, width: this.state.width, height: this.state.height }));
        this.onRootLayout = (event) => {
    ...
    render() {
        ...
        return (React.createElement(View, { style: [StyleSheet.absoluteFill, { backgroundColor: 'transparent' }, this.props.rootContainerStyle], pointerEvents: 'box-none', onLayout: this.onRootLayout },
